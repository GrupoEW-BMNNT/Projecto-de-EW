...
alter table "public"."user"  add column  "cursoano_oid"  int4;
alter table "public"."user"   add constraint fk_user_cursoano foreign key ("cursoano_oid") references "public"."cursoano" ("oid");
...
alter table "public"."pedido_de_impressao"  add column  "user_oid"  int4;
alter table "public"."pedido_de_impressao"   add constraint fk_pedido_de_impressao_user foreign key ("user_oid") references "public"."user" ("oid");
